...
public class OptionsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String prevSelectedLevel = StoreFacade.getInstance().getGameData(PREV_SELECTED_LEVEL_KEY);
    ...
    private void requestReceipts() {
        if (!StoreFacade.isRunningOnSupportedHardware(this)) {
            Toast.makeText(this, "You're not running on supported hardware!", Toast.LENGTH_SHORT).show();
        }

        StoreFacade.getInstance().requestReceipts(this, new ResponseListener<Collection<Receipt>>() {
            @Override
    ...
    private void requestPurchase(final Options.Level level)
        ...
        StoreFacade.getInstance().requestPurchase(this, purchasable, new ResponseListener<PurchaseResult>() {
            @Override
    ...
    private void selectLevel(Options.Level level) {
        ...
        StoreFacade.getInstance().putGameData(PREV_SELECTED_LEVEL_KEY, level.toString());
    }
}
